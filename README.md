...
<table>
  ...
  <tr>
    ...
    <td>В проекте преверяется, увеличится ли выручка интернет магазина, после нововведений. Рассматриваются также разные способы приоритизации гипотез по увеличению выручки.</td>
  ...
  <tr>
    ...
    <td>pandas, numpy, matplotlib, math, datetime, plotly.express, модуль stats из библиотеки scipy, исследовательский анализ, проверка статистически значимой различий между долями групп</td>
  </tr>
</table>
